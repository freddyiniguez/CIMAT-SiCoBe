...
<h2 class="title">Modificar Dependencia</h2>
    <form class="form-horizontal">
		<!--Buscar dependencia-->
		<div class="control-group">
		  <label class="control-label" for="singlebutton">Buscar</label>
		  <div class="controls">
		    <input type="text" class="input-xlarge" name="txtBuscar" placeholder="Nombre de la dependencia" required=""/>
    ...
    <div class="control-group">
      ...
      <div class="controls">
        <input type="text" class="input-xlarge" name="txtNombre" required=""/>
      </div>
    </div>
		<!--dirección-->
		<div class="control-group">
