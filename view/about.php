...
<nav>
    ...
    <li class="item_selected"><a href="about.php">Acerca de</a></li>
    </ul>
  </nav>
</div>
<div class="content">
...
<h2 class="title">Acerca de SiCoBe</h2>
<p>&nbsp;</p>
<p>SiCoBe nace en el año 2015 debido a la necesidad de la Secretaría de Economía del Estado
de Zacatecas (SEZAC), que a través de sus múltiples direcciones y programas de apoyo a la 
economía del estado, beneficia a distintas personas, organizaciones y empresas. El motivo de 
este Sistema es distribuir de una manera mas equitativa los recursos para poder beneficiar a
un mayor número de habitantes ya que frecuentemente una sola persona es beneficiaria de
múltiples programas (porque son administrados por múltiples direcciones) y esto genera que otras
ya no alcancen ningún tipo de apoyo.
<br>
</p>
</div>
</div>
